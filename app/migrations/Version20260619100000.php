...
SQLCORE;
        ...
        // Index unique (obligatoire pour REFRESH ... CONCURRENTLY). Inclut oidech
        // car cle_ecriture seule n'est plus unique depuis la cle composite mirror.
        $this->addSql('CREATE UNIQUE INDEX uniq_mv_reco ON garanties.mv_reconciliation (vue_lettree, cle_ecriture, oidech)');
        // Index de tri/filtre les plus courants.
    ...
    {
        // Retour a l'index unique sans oidech : ne fonctionne que si le mirror
        // ne contient pas (encore) de doublons de cle_ecriture.
        $this->addSql('DROP MATERIALIZED VIEW IF EXISTS garanties.mv_reconciliation');
    }
}
