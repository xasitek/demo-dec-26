...
SQLCORE;
    ...
    {
        // La definition precedente est recreee par Version20260622120000 (relancer la migration).
        $this->addSql('DROP MATERIALIZED VIEW IF EXISTS garanties.mv_reconciliation');
    }
}
